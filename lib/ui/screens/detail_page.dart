                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            r'Dh' + _plantList[widget.plantId].price.toString(),
                            style: TextStyle(
          ...
          children: [
            Container(
              ...
              child: IconButton(onPressed: (){
                ...
                Icons.shopping_cart,
                color: _plantList[widget.plantId].isSelected == true ? Color.fromARGB(255, 250, 250, 248) : Constants.primaryColor,
              )),
              decoration: BoxDecoration(
                  color: _plantList[widget.plantId].isSelected == true ? Constants.primaryColor.withOpacity(.5) : Color.fromARGB(255, 255, 255, 255),
